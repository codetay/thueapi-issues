        ...
        <div class="invoice">
            ...
            <div class="sidebar-sticky">
                <style>
                    ...
                    .panel-summary-primary, .border-2.border-red-500.border-solid {
                        background: #ffffff !important;
                        color: #0a0a0a !important;
                    }

                    .price-title, .price-amount, .panel-summary.panel-summary-primary.view-invoice label, .payment-form p {
                        color: #0a0a0a !important;
                    }
                    ...
                    .position-absolute .text-base.mb-10 {
                        display: none;
                    }
