=== ThueAPI - Thanh toán đơn giản với hệ thống tự động ! ===
 - Author: #CODETAY
 - Contributors: codetay
 - Tags: woocommerce, payment gateway, auto payment gateway, giao dich tu dong, plugin thanh toan tu dong, momo, vietcombank, techcombank, acb, mbbank, sacombank, vpbank, tpbank
 - Version: 1.0.3
 - Tested up to: 5.7
...
- Giải pháp thanh toán đơn giản & tiện lợi
...
1. Trước tiên download plugin này về và giải nén ra thư mục `thueapi-for-woocommerce`.
